// Copyright (c) Acconeer AB, 2015-2020
// All rights reserved
...
extern void (*acc_board_hibernate_enter_func)(acc_sensor_id_t sensor);
extern void (*acc_board_hibernate_exit_func)(acc_sensor_id_t sensor);
