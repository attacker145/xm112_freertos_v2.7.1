 ...
 */
size_t acc_detector_obstacle_processing_get_size(acc_detector_obstacle_configuration_t obstacle_configuration,
 ...
 */
size_t acc_detector_obstacle_processing_background_estimation_get_size(void);
...
/**
 * @brief Calculate update rate for a configuration
 *
 * @param[in] configuration Obstacle detector configuration
 * @return Update rate
 */
float acc_detector_obstacle_processing_calculate_update_rate(acc_detector_obstacle_configuration_t configuration);
